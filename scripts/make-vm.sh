...
then
  stanza compiler/stz-utils.stanza compiler/stz-vm-ir.stanza compiler/stz-dl-ir.stanza compiler/stz-loaded-ids.stanza compiler/stz-vm.stanza compiler/stz-vm-table.stanza compiler/stz-vm-bindings.stanza -o vm-bindings
elif [ $1 == "bindings" ]
then
